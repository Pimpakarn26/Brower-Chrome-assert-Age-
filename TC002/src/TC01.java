...
class UC01 {
    ...
    void testChrome() throws  InterruptedException {
        ...
        search_nameEN.sendKeys("Pimpakarn");
        search_lastnameEN.sendKeys("Kucharoensrichan");
        ...
        search_card.sendKeys("1200901344351");
        search_birthday.sendKeys("26/06/2546");
        search_phone.sendKeys("0624201938");
        search_email.sendKeys("654259009@webmail.npru.ac.th");
